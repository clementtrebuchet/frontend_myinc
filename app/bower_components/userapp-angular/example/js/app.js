...
config(['$routeProvider', function($routeProvider) {
	...
	$routeProvider.when('/welcome', {templateUrl: 'partials/partial1.html', controller: 'MyCtrl1'});
	$routeProvider.when('/admin', {templateUrl: 'partials/partial2.html', controller: 'MyCtrl2'});
